...
class SpotifyTools:
    ...
    def play(self, uri=None):
        self.client.play(context_uri=uri) if uri else self.client.play()
        return {"started": True, "uri": uri}
    ...
    def volume(self, percent):
        ...
        return {"percent": max(0, min(100, int(percent)))}
